...
class SaleDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sale_detail" do
    assert_difference("SaleDetail.count") do
      post sale_details_url, params: { sale_detail: { import: @sale_detail.import, unit: @sale_detail.unit } }
    end
  ...
  test "should update sale_detail" do
    patch sale_detail_url(@sale_detail), params: { sale_detail: { import: @sale_detail.import, unit: @sale_detail.unit } }
